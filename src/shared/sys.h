...
unsigned char __at(0x81BA) paddle[6];
unsigned char __at(0x81EA) spinner[12];
unsigned char __at(0x824A) ps2_key[2];
unsigned char __at(0x8256) ps2_mouse[6];
unsigned char __at(0x8286) starfield1[5];
unsigned char __at(0x8296) starfield2[5];
unsigned char __at(0x82A6) starfield3[5];
unsigned char __at(0x82B6) system_pause;
unsigned char __at(0x82B7) system_menu;
// - Charles (sound)
unsigned char __at(0x8300) sndram[16];
// - Deikun (music)
unsigned char __at(0x8310) musicram[4];
// - Vulcan (vector engine)
unsigned char __at(0x8320) vectorram[512];
// - Zechs (tilemap)
