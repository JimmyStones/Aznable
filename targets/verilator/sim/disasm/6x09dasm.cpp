...
util::disasm_interface::u32 m6x09_base_disassembler::opcode_alignment() const
{
	return 1;
}
...
util::disasm_interface::offs_t m6x09_base_disassembler::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params)
{
	uint8_t pb;
	unsigned int ea;
	int offset;
