...
const util::disasm_interface::u32 z80_disassembler::s_flags[] =
{
...
util::disasm_interface::u32 z80_disassembler::offs(s8 offset)
{
	if (offset < 0)
		return -offset;
	return offset;
...
util::disasm_interface::u32 z80_disassembler::opcode_alignment() const
{
	return 1;
}

util::disasm_interface::offs_t z80_disassembler::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params)
{
	s8 offset = 0;
